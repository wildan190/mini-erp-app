...
class EmployeeController extends Controller
{
    ...
    #[OA\Get(
        ...
        parameters: [
            ...
            new OA\Parameter(name: "search", in: "query", description: "Search by name, emp_code, or email", schema: new OA\Schema(type: "string")),
    ...
    {
        $filters = request()->only(['search', 'department_uuid', 'designation_uuid', 'status']);
